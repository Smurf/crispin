...
chvt 6    
 ...
 read -p "Enter primary LUKS key: " LUKS_KEY    
...
echo "part btrfs.249 --fstype=\"btrfs\" --ondisk=nvme0n1 --size=486400 --encrypted --luks-version=luks2 --passphrase=LUKS_KEY" >> /tmp/part.ks
